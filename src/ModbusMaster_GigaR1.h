...
/*
  ...
  ModbusMaster_GigaR1.h - Arduino library for communicating with Modbus slaves
...
#ifndef ModbusMaster_GigaR1_h
#define ModbusMaster_GigaR1_h
...
RS232/485 (via RTU protocol). Optimized for Arduino Giga R1.
*/
class ModbusMaster_GigaR1
{
  public:
    ModbusMaster_GigaR1();
  ...
  private:
    ...
    // Optimized timing constants for Arduino Giga R1
    static const uint16_t ku16MBResponseTimeout          = 3000; ///< Modbus timeout [milliseconds] - optimized for Giga R1
    static const uint16_t ku16MBInterFrameDelay         = 5;    ///< Delay between frames [milliseconds] - reduced for Giga R1
    static const uint16_t ku16MBByteTimeout             = 100;  ///< Timeout per byte [milliseconds] - increased for reliability
    static const uint8_t  ku8MBMaxRetries               = 2;    ///< Maximum retry attempts - reduced to avoid excessive delays
    static const uint16_t ku16MBTransmitDelay           = 1;    ///< Delay after transmission [milliseconds]
    static const uint16_t ku16MBReceiveDelay            = 2;    ///< Delay before receiving [milliseconds]
